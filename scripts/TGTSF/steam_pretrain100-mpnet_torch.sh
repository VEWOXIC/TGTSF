...
if [ ! -d "./logs/TGTSF_Steam_pretrain-mpnet-torch" ]; then
    mkdir ./logs/TGTSF_Steam_pretrain-mpnet-torch
...
do
    ...
    do
        ...
        --pct_start 0.2\
        --revin 0\
        --itr 1 --batch_size $bs --learning_rate 1e-4   | tee logs/TGTSF_Steam_pretrain-mpnet-torch/norin_nodate_lr1e-4-$model_name'_'$model_id_name'_'$seq_len'_'$pred_len'_bs'$bs.log 
    done
done

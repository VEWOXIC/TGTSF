...
if [ ! -d "./logs/TGTSF_Steam_pretrain-mpnet-torch_v1" ]; then
    mkdir ./logs/TGTSF_Steam_pretrain-mpnet-torch_v1

fi
seq_len=60
model_name=TGTSF_torch_v1
...
do
    ...
    do
        ...
        --patience 50\
        --target 'Players' \
        --itr 1 --batch_size $bs --learning_rate 5e-6   | tee logs/TGTSF_Steam_pretrain-mpnet-torch_v1/lr5e-6-$model_name'_'$model_id_name'_'$seq_len'_'$pred_len'_bs'$bs'-100'.log 
    done
done

...
if [ ! -d "./logs/TGTSF_Steam_pretrain-mpnet" ]; then
    mkdir ./logs/TGTSF_Steam_pretrain-mpnet
...
model_id_name=steam100-mpnet-noself
data_name=investing
...
do
    ...
    do
        ...
        --patience 50\
        --target 'Players' \
        --itr 1 --batch_size $bs --learning_rate 1e-6   | tee logs/TGTSF_Steam_pretrain-mpnet/noself-$model_name'_'$model_id_name'_'$seq_len'_'$pred_len'_bs'$bs'-100'.log 
    done
done

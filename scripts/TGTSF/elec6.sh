...
do
    ...
    do
        ...
        --lradj 'TST' \
        --pct_start 0.2\
        --itr 1 --batch_size $bs --learning_rate 0.0001  | tee logs/TGTSF_torch_elec/$model_name'_'$model_id_name'_'$seq_len'_'$pred_len'_bs'$bs'_patchlen1212_zero_Pemb_extraselflayer'.log 
    done
done
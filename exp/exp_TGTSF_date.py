from data_provider.data_factory import TGTSF_data_provider, TGTSF_elec_data_provider
...
class Exp_Main(Exp_Basic):
    ...
    def _get_data(self, flag):
        data_set, data_loader = TGTSF_elec_data_provider(self.args, flag, text_encoder=self.text_encoder)
    ...
    def vali(self, vali_data, vali_loader, criterion):
        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, batch_news, batch_des, news_mask) in enumerate(vali_loader):
                ...
                batch_news = batch_news[:, ::self.args.stride, :, :]
                batch_des = batch_des[:, ::self.args.stride, :, :]
                news_mask = news_mask[:, ::self.args.stride, :]
